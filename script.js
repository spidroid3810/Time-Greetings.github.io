document.write("<center><font size=+3>");
    ...
    var hr = day.getHours();
    if (hr >= 0 && hr < 12) {
        document.write("<img class='sun' src='sun.png'><body style='background: linear-gradient(#f4bde1,#abe4ff,#98d5f2,#6bcdea,#40c6e3);text-align: center;position:fixed;margin-left:auto; margin-right: auto;display: flex;justify-content: center; align-items: center;'><h3 class='day'>Good Morning!</h3>");
    }  else if (hr >= 12 && hr <= 16) {
